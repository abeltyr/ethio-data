...
import type { CommodityPrice, Commodity, Market, CommodityCategory } from "../../shared/types";
...
import { saveCommodityPrices } from "../../shared/database/save";
...
export async function fetchWorldBankRtp(_task: ProviderTaskConfig): Promise<number> {
  const db = getProviderDb("worldbank_rtp");
