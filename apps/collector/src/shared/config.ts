...
import { REPO_ROOT } from "@ethiodata/database";
...
// DB_DIR / DB_PATH now live in @ethiodata/database (repo-root-anchored).
export const LOG_FILE = process.env.LOG_FILE || join(REPO_ROOT, "failed_dates.log");
